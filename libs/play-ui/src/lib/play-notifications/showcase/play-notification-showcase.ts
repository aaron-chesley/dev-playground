...
import { PlayNotificationService } from '../play-notification.service';
...
@Component({
  selector: 'play-notification-shocase',
  template: `<button (click)="requestNotificationPermission()">
      Enable Notifications
    </button>
    <button (click)="sendNotification()">Send Notification</button> `,
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class PlayNotificationShowcaseComponent {
  sendNotification() {
  ...
  constructor(private notificationService: PlayNotificationService) {}
}

@NgModule({
  imports: [],
  exports: [PlayNotificationShowcaseComponent],
  declarations: [PlayNotificationShowcaseComponent],
  providers: [],
})
export class PlayNotificationShowcaseModule {}
